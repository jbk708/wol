...
The website and the analysis code are two independent stacks.

**Website** (Jekyll 4, deployed by GitHub Actions):
...
**Analysis code** under [`code`](code) ([uv](https://docs.astral.sh/uv/)):
