...
- [**tree.nwk**](tree.nwk) is the recommended reference phylogeny. It is identical to [astral](astral) &rarr; `branch_length` &rarr; `cons` &rarr; `collapsed` &rarr; [astral.cons.nid.e5p50.nwk](astral/branch_length/cons/collapsed/astral.cons.nid.e5p50.nwk). See below for details.
